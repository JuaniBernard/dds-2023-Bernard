...
public class EjercicioUniUnoMuchoApplication {
	@Autowired
	PersonaRepository personaRepository;

	public static void main(String[] args) {
		SpringApplication.run(EjercicioUniUnoMuchoApplication.class, args);
		System.out.println("Probando OneToMany unidireccional");
	}
	@Bean
