package com.um.ejercicioBidiUnoMucho;

import com.um.ejercicioBidiUnoMucho.entidades.Domicilio;
import com.um.ejercicioBidiUnoMucho.entidades.Persona;
import com.um.ejercicioBidiUnoMucho.repositorios.DomicilioRepository;
import com.um.ejercicioBidiUnoMucho.repositorios.PersonaRepository;
...
public class EjercicioBidiUnoMuchoApplication {
	@Autowired
	PersonaRepository personaRepository;
	@Autowired
	DomicilioRepository domicilioRepository;
	public static void main(String[] args) {
		SpringApplication.run(EjercicioBidiUnoMuchoApplication.class, args);
		System.out.println("Probando OneToMany bidireccional");
	}
	@Bean
